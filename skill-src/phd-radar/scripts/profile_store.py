...
DEFAULT_PROFILE = {
    ...
    "search_mode": "stable_refresh",
    "search_budget": {"max_pages_per_source": 5, "max_results_per_query": 10, "expansion_batches": 3},
    "candidate_ledger": {"enabled": True, "db_name": "candidates.sqlite3", "carry_forward_days": 45, "stale_after_missed_runs": 3},
